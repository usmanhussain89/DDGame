	...
	class InteractionListener extends MouseAdapter {
		...
		public void mouseClicked(MouseEvent e) {
			...
			if (new_mapModel.mapGridSelection[x][y] == GameStatics.MAP_OPPONENT_POINT
					&& mapButtonsGrid2DArray[x][y].getText().equals("Hostile")) {
				if (e.isShiftDown()) {
					e.consume();
					if (e.getButton() == MouseEvent.BUTTON3) {
			...
			if (new_mapModel.mapGridSelection[x][y] == GameStatics.MAP_OPPONENT_POINT
					&& mapButtonsGrid2DArray[x][y].getText().equals("Dead")) {
				Character hostileCharacter = gameEngine.getCurrentMap().getHostileCharacter();
			...
			if (new_mapModel.mapGridSelection[x][y] == GameStatics.MAP_EXIT_POINT) {
				...
				if (hostileCharacter.getNPCType() == NPCType.DEAD) {
					...
					if (gameEngine.getCharacter().getLevel() == 4 || gameEngine.getCharacter().getLevel() == 6
							|| gameEngine.getCharacter().getLevel() == 8 || gameEngine.getCharacter().getLevel() == 12
							|| gameEngine.getCharacter().getLevel() == 14 || gameEngine.getCharacter().getLevel() == 16
							|| gameEngine.getCharacter().getLevel() == 19) {
						JList<CharacterAttribute> list = new JList(
								new CharacterAttribute[] { CharacterAttribute.DEXTERITY, CharacterAttribute.WISDOM,
										CharacterAttribute.STRENGTH, CharacterAttribute.ATTACK_BONUS,
										CharacterAttribute.CONSTITUTION, CharacterAttribute.CHARISMA });
						boolean flag = true;
						while (flag) {
							JOptionPane.showMessageDialog(null, list, "Multi-Select Example",
							...
							if (list.getSelectedIndices().length > 0 && list.getSelectedIndices().length <= 2) {
								...
								if (list.getSelectedIndices().length == 1) {
									for (int index : list.getSelectedIndices()) {
										...
										case 0:
											System.out.println(
													"Dexterity Before : " + gameEngine.getCharacter().getDexterity());
											gameEngine.getCharacter()
													.setDexterity(gameEngine.getCharacter().getDexterity() + 2);
											System.out.println(
													"Dexterity After : " + gameEngine.getCharacter().getDexterity());
											break;
										case 1:
											System.out.println(
													"Wisdom Before : " + gameEngine.getCharacter().getWisdom());
											gameEngine.getCharacter()
													.setWisdom(gameEngine.getCharacter().getWisdom() + 2);
											System.out
													.println("Wisdom After : " + gameEngine.getCharacter().getWisdom());
											break;
										case 2:
											System.out.println(
													"Strength Before : " + gameEngine.getCharacter().getStrength());
											gameEngine.getCharacter()
													.setStrength(gameEngine.getCharacter().getStrength() + 2);
											System.out.println(
													"Strength Before : " + gameEngine.getCharacter().getStrength());
											break;
										case 3:
											System.out.println("AttackBonus Before : "
													+ gameEngine.getCharacter().getAttackBonus());
											gameEngine.getCharacter()
													.setAttackBonus(gameEngine.getCharacter().getAttackBonus() + 2);
											System.out.println("AttackBonus Before : "
													+ gameEngine.getCharacter().getAttackBonus());
											break;
										case 4:
											System.out.println("Constitution Before : "
													+ gameEngine.getCharacter().getConstitution());
											gameEngine.getCharacter()
													.setConstitution(gameEngine.getCharacter().getConstitution() + 2);
											System.out.println("Constitution Before : "
													+ gameEngine.getCharacter().getConstitution());
											break;
										case 5:
											System.out.println(
													"Charisma Before : " + gameEngine.getCharacter().getCharisma());
											gameEngine.getCharacter()
													.setCharisma(gameEngine.getCharacter().getCharisma() + 2);
											System.out.println(
													"Charisma Before : " + gameEngine.getCharacter().getCharisma());
											break;
										}
									...
									for (int index : list.getSelectedIndices()) {
										...
										case 0:
											System.out.println(
													"Dexterity Before : " + gameEngine.getCharacter().getDexterity());
											gameEngine.getCharacter()
													.setDexterity(gameEngine.getCharacter().getDexterity() + 1);
											System.out.println(
													"Dexterity After : " + gameEngine.getCharacter().getDexterity());
											break;
										case 1:
											System.out.println(
													"Wisdom Before : " + gameEngine.getCharacter().getWisdom());
											gameEngine.getCharacter()
													.setWisdom(gameEngine.getCharacter().getWisdom() + 1);
											System.out
													.println("Wisdom After : " + gameEngine.getCharacter().getWisdom());
											break;
										case 2:
											System.out.println(
													"Strength Before : " + gameEngine.getCharacter().getStrength());
											gameEngine.getCharacter()
													.setStrength(gameEngine.getCharacter().getStrength() + 1);
											System.out.println(
													"Strength Before : " + gameEngine.getCharacter().getStrength());
											break;
										case 3:
											System.out.println("AttackBonus Before : "
													+ gameEngine.getCharacter().getAttackBonus());
											gameEngine.getCharacter()
													.setAttackBonus(gameEngine.getCharacter().getAttackBonus() + 1);
											System.out.println("AttackBonus Before : "
													+ gameEngine.getCharacter().getAttackBonus());
											break;
										case 4:
											System.out.println("Constitution Before : "
													+ gameEngine.getCharacter().getConstitution());
											gameEngine.getCharacter()
													.setConstitution(gameEngine.getCharacter().getConstitution() + 1);
											System.out.println("Constitution Before : "
													+ gameEngine.getCharacter().getConstitution());
											break;
										case 5:
											System.out.println(
													"Charisma Before : " + gameEngine.getCharacter().getCharisma());
											gameEngine.getCharacter()
													.setCharisma(gameEngine.getCharacter().getCharisma() + 1);
											System.out.println(
													"Charisma Before : " + gameEngine.getCharacter().getCharisma());
											break;
										}
