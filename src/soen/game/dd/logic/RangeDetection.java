...
/**
 * This is a range detection helper class for the gameengine. Detects whether
 * two characters are in range with each other, and who is within the vicinity
 * of one character
 * 
...
public class RangeDetection {
	...
	/**
	 * This is the constructor of Range detection passing passing GameEngine
	 * object
	 * 
	 * @param ge
	 */
