...
public class MapValidation {
	...
	public String mapValidations(Map new_mapModel) {
		...
		/*
		 * else if ((!new_mapModel.isCharacterDone ||
		 * !new_mapModel.isOpponentDone) || (new_mapModel.getCharacterPoint() ==
		 * null || new_mapModel.getOpponentPoint() == null)) { routeStatus =
		 * "Please First Select a Character Point.";
		 * new_mapModel.setMapAutoGeneratedDescription(routeStatus); }
		 */
