...
public class TestObjects {
	...
	public void saveLoadObjects_Test() throws FileNotFoundException, ClassNotFoundException, IOException{
		...
		Character nightFighter = new Character("Night Fighter", description, level, abilityScores, abilityModifier, hitPoint, armorClass, attackBonus, damageBonus, multipleAttacks, armore, ring, helmet, boots, belt, sword, shield)
